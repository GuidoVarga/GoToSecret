<?php namespace views\admin\ategory; ?>
<body class="category_edit">
    <div id="wrapper">
                                            ...
                                            <form action="edit" method="POST">
                                                    <div class="border border-grey p-4">
                                                        <div class="text-right">
                                                            ...
                                                            <a href="<?php echo "/".DIRECTORY."/"."AdminCategory"?>" class="btn btn-danger mt-2 mt-sm-0"><i class="fa fa-arrow-circle-left"></i> Volver</a>
                                                        </div>
                                                    <div class="row">
                                                        <div class="col-12 mt-5 mb-3">
                                                        <h2 style="color:#da4f49">Editar Categoria</h2>
                                                        </div>
                                                        <div class="col-md-6">
