                                    ...
                                    <div class="col-lg-12">
                                        <div class="border border-grey p-4">
                                            <div class="text-right">
                                                <a href="<?php echo "/".DIRECTORY."/"."AdminCategory/addView"?>" class="btn btn-primary"><i class="fas fa-plus"></i> Nueva Categoria</a>
                                            </div>
                                            <div class="table-responsive mt-4">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="<?php echo "/".DIRECTORY."/"."AdminCategory/editView"?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>                            
